...
% The report is compiled from ``zombie_poisson_streamlit/report``.  Keeping the
% asset directory here centralizes every image lookup after the reorganization.
\graphicspath{{../assets/}}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.96\textwidth]{outbreak-command-center.png}
