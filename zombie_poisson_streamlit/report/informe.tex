...
% Portada construida con los integrantes declarados en la licencia del proyecto.
...
La versión auditada agrega pruebas formales de bondad de ajuste, independencia,
dispersión y aceptación; comparación pareada con McNemar, Wilcoxon y bootstrap;
...
\midrule
Horizonte & 90 & s & Tasa & 39 & llegadas/min \\
CV Polar & 0.45 & --- & HP protagonista & 110 & HP \\
DPS protagonista & 42 & HP/s & Alcance & 10 & m \\
HP infectado & 42 & HP & Velocidad & 1.55 & m/s \\
DPS infectado & 9 & HP/s & Paso $dt$ & 0.05 & s \\
...
horizonte. Se adopta $\alpha=0.05$ y se ejecutan:

\begin{itemize}
  \item KS contra Exponencial$(\lambda)$;
  \item KS de las normales Marsaglia contra $N(0,1)$;
  \item KS contra la lognormal parametrizada;
  \item Pearson de rezago uno para independencia;
  \item índice de dispersión sobre 600 calendarios Poisson;
  \item prueba binomial de aceptación Polar contra $\pi/4$.
\end{itemize}
...
\begin{table}[H]
\centering
\caption{Contrastes principales, $\alpha=0.05$.}
\begin{tabular}{lll}
\toprule
...
Polar-lognormal & KS lognormal & \LognormalKSP \\
Conteo Poisson & Índice de dispersión & \CountDispersionP \\
\bottomrule
\end{tabular}
\end{table}

Los siete contrastes completos no fueron rechazados al 5\,\%. La
Figura~\ref{fig:validation} inspecciona forma, cuantiles y conteos.

\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{report-generator-validation.png}
  \caption{Histogramas, densidades, Q-Q normal y conteos Poisson.}
...
presión supera la capacidad ofensiva y cae la supervivencia. Con CV 0.45,
...
\begin{enumerate}
  \item Siete contrastes fueron coherentes con los generadores declarados.
