...
calendario, con \TestCount{} contrastes que no se solapan entre sí y corrección
...
\emph{Por qué se corrige por multiplicidad.} Con \TestCount{} contrastes
simultáneos al 5\,\%, la probabilidad de que al menos uno se rechace por azar
supera el 60\,\%. La decisión se toma sobre el valor $p$ ajustado por
Holm-Bonferroni, que controla la tasa de error por familia sin suponer
...
La suite contiene veintiuna pruebas:
